...
export default function LedgerPage() {
  const { ledgerCategories, ledgerEntries, addLedgerCategory, deleteLedgerCategory, addLedgerEntry, deleteLedgerEntry, settings, currentUser } = useStore();
      ...
      <div className="w-60 flex-shrink-0 flex flex-col gap-3 h-[calc(100vh-140px)]">
        ...
        <div className="category-panel flex-1 overflow-y-auto custom-scrollbar">
          <div className="px-3 py-2">
            <h2 className="text-[10px] font-black text-slate-400 dark:text-dark-500 uppercase tracking-[0.2em]">Registered Ledgers</h2>
          </div>
