...
export default function Dashboard() {
  ...
  const {
    ...
    assetCategories, liabilityCategories, customers
  } = useStore();
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      counts: {
        ...
        liability: liabilityCategories.length,
        customer: customers.length,
      }
    };
  }, [rawPurchases, rawSales, rawExpenses, assetCategories, liabilityCategories, customers, filter]);
