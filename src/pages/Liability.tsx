...
export default function LiabilityPage() {
  ...
  }, [liabilityEntries, selectedCat, search, fromDate, toDate]);
      ...
      <div className="w-60 flex-shrink-0 flex flex-col gap-3 h-[calc(100vh-140px)]">
        ...
        <div className="category-panel flex-1 overflow-y-auto custom-scrollbar text-left">
          <div className="px-3 py-2">
            <h2 className="text-[10px] font-black text-slate-400 dark:text-dark-500 uppercase tracking-[0.2em]">Liability Types</h2>
          </div>
                  ...
                  {paged.length > 0 && (
                    <tfoot className="bg-slate-50/50 dark:bg-dark-800/50 font-semibold border-t border-slate-200 dark:border-dark-700/50">
                      <tr>
                        ...
                        <td className="table-cell text-right text-orange-600 dark:text-orange-400">₨ {formatCurrency(pageTotals.credit - pageTotals.debit)}</td>
