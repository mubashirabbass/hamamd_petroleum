               ...
               {liabilityCategories.map(c => (
                 <button
                   ...
                   className={cn(
                     ...
                     selectedCat === c.id 
                       ? "pill-nav-item-active bg-orange-600 border-orange-600 shadow-orange-500/30" 
                       : "bg-white dark:bg-dark-900 border-slate-100 dark:border-dark-800 hover:border-orange-200"
                   )}
                 >
                   {c.name}
                 </button>
                        ...
                        <tr key={e.id} className="table-row text-[11px] hover:bg-slate-50 dark:hover:bg-dark-800/50 transition-all group">
                          ...
                          <td className="table-cell text-center">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              <button 
                                 onClick={() => { if(window.confirm('Modify this liability entry?')) handleEdit(e); }} 
                               ...
                               {(currentUser?.role === 'Admin' || currentUser?.role === 'Developer') && (
                                 <button 
                                   onClick={() => { if(window.confirm('Permanently delete this liability record?')) deleteLiabilityEntry(e.id); }} 
