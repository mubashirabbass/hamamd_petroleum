               ...
               {assetCategories.map(c => (
                 <button
                   ...
                   className={cn(
                     ...
                     selectedCat === c.id 
                       ? "pill-nav-item-active bg-emerald-600 border-emerald-600 shadow-emerald-500/30" 
                       : "bg-white dark:bg-dark-900 border-slate-100 dark:border-dark-800 hover:border-emerald-200"
                   )}
                 >
                   {c.name}
                 </button>
