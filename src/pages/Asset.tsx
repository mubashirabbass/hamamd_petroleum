    ...
    <div className="animate-fade-in flex flex-col h-full w-full overflow-hidden">
      ...
      {showReport && cat && (
        <PrintReportModal
          ...
          type="asset"
          title={`${cat.name} Asset Statement`}
          columns={[
            { header: 'Date', accessor: 'date' },
            { header: 'Description', accessor: 'description' },
            { header: 'Debit (In)', accessor: 'debit', align: 'right', isCurrency: true },
            { header: 'Credit (Out)', accessor: 'credit', align: 'right', isCurrency: true },
            { header: 'Valuation', accessor: 'balance', align: 'right', isCurrency: true },
          ]}
          data={withBalance}
          totals={{
            debit: totals.debit,
      ...
      {showSummaryReport && (
        <PrintReportModal
          ...
          columns={[
            ...
            { header: 'Current Valuation', accessor: 'balance', align: 'right', isCurrency: true },
          ]}
          data={(() => {
          ...
          totals={{
            balance: (() => {
              ...
              const filteredCats = assetCategories.filter(c => !dashboardSearch || c.name.toLowerCase().includes(dashboardSearch.toLowerCase()));
        ...
        >
          <form onSubmit={handleSubmit} className="flex flex-col gap-1">
            ...
            <div className="px-2 space-y-1">
              <div className="desktop-form-row">
                <label className="desktop-form-label text-emerald-600 dark:text-emerald-400">Debit (In)</label>
                <div className="desktop-form-field">
                  <input 
                    type="number" 
                    step="any" 
              ...
              <div className="desktop-form-row !border-b-0">
                <label className="desktop-form-label text-red-600 dark:text-red-400">Credit (Out)</label>
                <div className="desktop-form-field">
                  <input 
                    type="number" 
                    step="any" 
            ...
            <div className="desktop-form-footer">
              <div className="desktop-summary-strip flex-1 mr-4">
                <div className="flex flex-col">
                  <span className="text-[9px] font-black text-slate-400 uppercase tracking-tighter">Valuation Change</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <button type="submit" disabled={isSaving} className="btn-primary !bg-emerald-600 hover:opacity-90 !py-2 !px-6">
