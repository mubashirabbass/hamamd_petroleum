        ...
        <div className="text-center mb-10">
          <div className="flex flex-col items-center justify-center gap-3 mb-2">
            ...
            <div className="mt-2 flex flex-col items-center gap-2">
              <h1 className={`login-brand-heading text-xl sm:text-2xl font-black transition-all duration-1000 font-urdu pt-4 min-h-[60px] leading-[1.8] text-center px-6 py-2 rounded-2xl soft-glass !bg-white/[0.12] text-white whitespace-nowrap ${typingFinished ? 'animate-glow-soft' : ''}`}>
                {displayText}
              </h1>
              <p className="text-white/90 text-[10px] sm:text-[11px] font-urdu px-3 py-1 soft-glass rounded-full !bg-white/[0.08] mt-1">
